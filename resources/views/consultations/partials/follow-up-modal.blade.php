    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="followUpForm" action="{{ route('follow-ups.store') }}" method="POST">
                @csrf
                <input type="hidden" name="consultation_id" id="followUpConsultationId" value="">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <x-form.input name="contact_date" label="Fecha del contacto" type="date" :value="now()->format('Y-m-d')" required/>
                        </div>
                        <div class="col-md-6 mb-3">
                            <x-form.input name="next_contact_date" label="Próximo contacto" type="date"/>
                            <small class="text-muted"> Opcional.</small>
                        </div>
                        <div class="col-md-6 mb-3">
                            <x-form.select name="communication_type" label="Tipo de comunicación" :options="config('options.communication_types')" placeholder="Seleccione..." required/>
                        </div>
                        <div class="col-md-6 mb-3">
                            <x-form.select name="result" label="Resultado" :options="config('options.follow_up_results')" placeholder="Seleccione..." required/>
                        </div>
                        <div class="col-12">
                            <x-form.textarea name="notes" label="Observaciones" rows="5"/>
                        </div>
                    </div>
                    <div id="followUpActions" class="mt-3 d-none">
                        <div id="generateCaseContainer" class="form-check d-none">
                            <input class="form-check-input" type="checkbox" id="generate_case" name="generate_case" value="1" checked>
                        ...
                        <div id="rejectConsultationContainer" class="form-check d-none">
                            <input class="form-check-input" type="checkbox" id="reject_consultation" name="reject_consultation" value="1" checked>
